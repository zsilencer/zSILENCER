...
public:
	...
	void DrawBrightened(SDL_Surface * src, SDL_Rect * srcrect, SDL_Surface * dst, SDL_Rect * dstrect, Uint8 brightness);
	void DrawAlphaed(SDL_Surface * src, SDL_Rect * srcrect, SDL_Surface * dst, SDL_Rect * dstrect);
	...
	void DrawMessageBackground(SDL_Surface * surface, SDL_Rect * dstrect);
